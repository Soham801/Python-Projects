...
recipient_number = input("Enter the recipient Whatsapp number with Country code (e.g, +913212342345)")
message_body = input(f"Enter the message you want to send to {name}: ")

#step 5 parse date/time and calculate delay
date_str = input('Enter the date to send the message (YYYY-MM-DD): ')
time_str = input('Enter the time to send the message (HH:MM in 24Hrs Format): ')
